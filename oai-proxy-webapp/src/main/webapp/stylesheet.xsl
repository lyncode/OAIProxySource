...
>
	...
	<xsl:template match="/">
		...
		<html>
			<head>
				<title>OAI Proxy Data Provider</title>
...
-->
					...
					<div class="footer">
						<div class="right">
							...
							<p class="image"><a href="http://www.lyncode.com"><img src="../images/lyncode.png" alt="Lyncode logo" /></a></p>
						</div>
					</div>
				</div>
			</body>
